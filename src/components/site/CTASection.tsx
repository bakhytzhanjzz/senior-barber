  ...
  return (
    <section className="relative overflow-hidden border-t border-ink-line/70">
      ...
      <div className="relative mx-auto max-w-3xl px-5 py-20 text-center sm:px-8 sm:py-28">
        ...
        <Link
          href={`/${locale}/booking`}
          className="mt-9 inline-block rounded-full bg-steel px-8 py-4 font-mono text-sm font-medium uppercase tracking-[0.14em] text-ink transition-transform hover:scale-[1.03] hover:bg-steel-bright"
        >
          {dict.cta.button}
        </Link>
      </div>
